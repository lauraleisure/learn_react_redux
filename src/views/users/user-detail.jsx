                   ...
                   <div className='user-wrapper'>
                       <div className='item-part bg-w'>
                           ...
                           <div className='items halfpxline_after flex-box jc-s ai-c'>
                               ...
                               <div className='txt-cont'>
                                   <input id='code' className='text-right' type='text' value={this.state.code} placeholder='短信验证码' onChange={this.changeVal.bind(this)}/>
                       ...
                       <div className='item-part bg-w'>
                           ...
                           <div className='items halfpxline_after flex-box jc-s ai-c'>
                               ...
                               <div className='txt-cont'><input id='repwd' className='text-right' type='password' value={this.state.repwd} placeholder='再次输入密码'onChange={this.changeVal.bind(this)}/></div>
                           </div>
                       </div>
